some_string = "om\n5       my name is igor HHHHHHHHH 666666666665454545  namer   "

upper = some_string.upper()  # ' MY NAME IS IGOR 666666666665454545'
lower = some_string.lower()  # ' my name is igor hhhhhhhhh 666666666665454545'
title = some_string.title()  # 'My Name Is Igor Hhhhhhhhh 666666666665454545'
capitalize = some_string.capitalize()  # 'My name is igor hhhhhhhhh 666666666665454545'
...
clear_string_symbols_right = some_string.rstrip(" 54naMer")
...
slice8 = some_string[-3:-20:-2]  # reverse
