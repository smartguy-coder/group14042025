some_list = [55, 656, 898, 55, 55, "Alex", 2222222222222222]
some_list2 = [55, 656, 898, 55, 11111111, "Alex", "5"]
some_iterable = "mjfggjhg54g545446"
...
# adding
created_set.add("555555555555555555")
# created_set.add([])
created_set.add((3,))
